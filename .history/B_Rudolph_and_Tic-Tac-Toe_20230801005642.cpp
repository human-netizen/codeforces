...
int main(){
    tc{
        ...
        if(ch[0][0] == ch[1][1] && ch[0][0] == ch[2][2] && ch[0][0] != '.' && draw == false)cout<<ch[0][0]<<endl , draw = false;
        if(ch[0][2] == ch[1][1] && ch[0][2] == ch[2][0] && ch[0][2] != '.' && draw == false)cout<<ch[0][2]<<endl , draw = false;
